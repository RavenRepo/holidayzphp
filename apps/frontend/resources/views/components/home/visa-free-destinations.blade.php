...
<section class="py-20 bg-gradient-to-br from-saffron/10 via-white to-brandblue/5">
    <div class="container mx-auto px-4">
        ...
        <div class="flex justify-center mt-10">
            <a href="{{ route('packages') }}" class="bg-brandblue hover:bg-brandblue/90 text-white font-medium py-3 px-8 rounded-full transition-all duration-300 shadow-soft hover:shadow-lg inline-flex items-center">
