...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            @foreach($features as $feature)
                <div class="text-center p-6 bg-gray-50 rounded-lg hover:shadow-lg transition-all duration-300 hover:-translate-y-2">
                    <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-saffron bg-opacity-20 text-saffron mb-4">
                        {!! $feature['icon'] !!}
                    </div>
        ...
        <div class="mt-16 text-center">
            <div class="p-8 max-w-4xl mx-auto bg-brandblue bg-opacity-5 rounded-lg border border-brandblue border-opacity-20">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    <div class="text-center">
                        <div class="text-3xl md:text-4xl font-bold text-brandblue mb-2">10,000+</div>
                        <p class="text-gray-600">Happy Travelers</p>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl md:text-4xl font-bold text-brandblue mb-2">200+</div>
                        <p class="text-gray-600">Destinations</p>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl md:text-4xl font-bold text-brandblue mb-2">98%</div>
